...
namespace UdonRabbit.Analyzer
{
    ...
    public class NotSupportSyncingOfType : DiagnosticAnalyzer
    {
        ...
        private const string HelpLinkUri = "https://github.com/mika-f/UdonRabbit.Analyzer/blob/master/docs/analyzers/URA0033.md";
        ...
        private static void AnalyzeFieldDeclaration(SyntaxNodeAnalysisContext context)
        {
            ...
            if (UdonSymbols.Instance != null && !UdonSymbols.Instance.FindUdonSyncType((INamedTypeSymbol) info.Symbol, "None"))
