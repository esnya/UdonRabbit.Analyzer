...
namespace UdonRabbit.Analyzer
{
    ...
    public class MethodCalledByCustomNetworkEventMustBePublic : DiagnosticAnalyzer
    {
        ...
        private const string HelpLinkUri = "https://github.com/mika-f/UdonRabbit.Analyzer/blob/master/docs/analyzers/URA0041.md";
        ...
        private static void AnalyzeMethodDeclaration(SyntaxNodeAnalysisContext context)
        {
            ...
            var hasCaller = invocations.Any(w =>
            {
                ...
                var str = arg.Expression.ToFullString();

                return arg.Expression switch
                {
                    LiteralExpressionSyntax literal => ParseLiteral(literal) == declaration.Identifier.Text,
                    InvocationExpressionSyntax invoke => ParseInvocation(invoke) == declaration.Identifier.Text,
                    _ => false
                };
            });
